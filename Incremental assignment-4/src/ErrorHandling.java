...
class ZeroNumberber_Exception extends Exception{}
class String_length_Exception extends Exception{}

public class ErrorHandling {
  static final int MIN_USERNAME_LENGTH = 5;
    static void method1(int number,String userName) throws Negative_Exception,ZeroNumberber_Exception,String_length_Exception {
      if(number<0){
       ...
       throw new Negative_Exception();
        ...
        if(number==0){
            ...
            throw new ZeroNumberber_Exception();
        }
        if(userName.isEmpty()){
    ...
    public static void main(String arg[]){
        ...
        catch (Negative_Exception | ZeroNumberber_Exception | String_length_Exception  n){
